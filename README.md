...
[![Build status](https://ci.appveyor.com/api/projects/status/plli5ijsdafnedod?svg=true)](https://ci.appveyor.com/project/ArtKonX/ra16-homeworks-forms-steps)

[Ссылка на Github Pages](https://artkonx.github.io/ra16-homeworks-forms-steps/)
